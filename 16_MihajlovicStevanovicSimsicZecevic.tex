...
\section{Uvod}
\label{sec:uvod}
Razvoj tehnologije i sve intenzivnije prisustvo i uticaj medija na život svakog pojedinca, doveli su do toga da UNESKO sedamdesetih godina prošlog veka prepozna potrebu da se u obrazovne sisteme širom sveta uvede upoznavanje učenika sa osnovnim elementima i karakteristikama medija koji ih okružuju. 

Skoro neprimetno, mediji su se od spoljnjeg faktora uzdigli do sveprožimajućeg elementa svake sfere savremenog društva. Iz sredstva informisanja prerasli su u sredstvo informisanja i manipulacije. Mnoštvo informacija sa kojima smo svakodnevno u kontaktu, dobijeno iz različitih izvora i plasirano na različite načine, oblikuje javno mnjenje.
...
Stoga je najpre važno objasniti način funkcionisanja savremenih medija i proces kritičkog razmišljanja, da bi se razumela suština medijske pismenosti.
...
\bibitem{prirucnik1} Priručnik za nastavnike \emph{ „Naši učenici u svetu kritičkog mišljenja i medijske pismenosti“}, grupa autora (po azbučnom redu): Vlajković Bojić Violeta, Miladinović Nenad, Milijić Subić Dejana, Milošević Ivana ;

\bibitem{prirucnik2} \emph{ „Osnove medijske pismenosti – priručnik za učenike“ (2014)}; Nedim Sejdinović i Tatjana Ljubić
