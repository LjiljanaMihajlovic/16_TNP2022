...
\author{Ljiljana Mihajlović, mihajlovic.ljiljana.154@gmail.com\\ Danica Šimšić, danica.simsic03@gmail.com\\Ana Stevanović, anas2811@gmail.com,\\ Tijana Zečević, zecevictijana03@gmail.com\\}
...
\begin{itemize}
	\item \textbf{Tradicionalnim medijima} smatra se bilo koji vid masovne komunikacije koji je postojao pre nego što je internet stupio na svetsku scenu. Tu se ubrajaju: \begin{itemize}
    \item \textbf {Svi vidovi štampanih medija} (slika \ref{fig:newspaper}), 
    \item \textbf {radio} (slika \ref{fig:radio}),
    \item \textbf {televizija} (slika \ref{fig:tv}),
    \item \textbf {pošta i poruke na javnim mestima}.
